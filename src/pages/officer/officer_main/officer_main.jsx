      ...
      >
        ...
        <header className={styles.hero}>
          ...
          <div className={styles["hello-area"]}>
            <p>안녕하세요 000소대장님</p>
            <span className={styles["hello-person-icon"]} />
          </div>
          ...
          <nav className={styles["main-nav"]}>
            ...
            <button
              className={`${styles["nav-button"]} ${styles["nav-active"]}`}
            >
              APPROVAL
            </button>
            <button
        ...
        <section className={styles["emergency-section"]}>
          <div className={styles["emergency-left"]}>
            ...
            <div className={styles["siren-icon"]} />
          </div>
        ...
        <section className={`${styles.feature} ${styles["feature-ai"]}`}>
          <div
            className={`${styles["feature-icon"]} ${styles["document-icon"]}`}
          />
        ...
        <section className={`${styles.feature} ${styles["feature-personnel"]}`}>
          <div
            className={`${styles["feature-icon"]} ${styles["personnel-icon"]}`}
          />
        ...
        <section className={`${styles.feature} ${styles["feature-schedule"]}`}>
          <div
            className={`${styles["feature-icon"]} ${styles["small-calendar-icon"]}`}
          />
        ...
        <section className={styles["bottom-section"]}>
          ...
          >
            <div className={styles["bottom-card-icon"]}>
              <strong>1</strong>
              <span className={styles["bottom-calendar-icon"]} />
            </div>
            <p>소대 일정 조회</p>
          </button>
          ...
          >
            <div className={styles["bottom-card-icon"]}>
              <strong>1</strong>
              <span className={styles["bottom-personnel-icon"]} />
            </div>
            <p>소대 병력 조회</p>
          </button>
        </section>
